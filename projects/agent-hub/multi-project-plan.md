...
projects:
  ...
  vm-mcp:
    ...
    root_dir: /Users/huayang/code/vm-mcp
...
| 项目 | project_id | 代码目录 |
|------|-----------|----------|
| agent-hub | 3 | /Users/huayang/code/agents/ |
| vm-mcp | 4 | /Users/huayang/code/vm-mcp/ |
...
Agent dev-alex (projects: [agent-hub]):
  skills 来源：
    ...
    2. /Users/huayang/code/agents/.claude/skills/  → agent-hub 项目 skills（--add-dir 自动发现）

Agent dev-emma (projects: [vm-mcp]):
  skills 来源：
    1. agents/dev-emma/.claude/skills/    → 共享 + 模板 skills（setup-agents.py 管理）
    2. /Users/huayang/code/vm-mcp/.claude/skills/  → vm-mcp 项目 skills（--add-dir 自动发现）
```

### 4.4 迁移

现有 Agent-Hub 项目 skills 需要从 `projects/agent-hub/skills/` 迁移到 `/Users/huayang/code/agents/.claude/skills/`。`setup-agents.py` 中现有的项目 skill symlink 逻辑可以移除。
...
```
agents repo (ROOT_DIR = /Users/huayang/code/agents/):
...
vm-mcp repo (/Users/huayang/code/vm-mcp/):
...
11. 迁移 Agent-Hub skills：`projects/agent-hub/skills/` → `/Users/huayang/code/agents/.claude/skills/`
12. 迁移 VM MCP skills 到 `/Users/huayang/code/vm-mcp/.claude/skills/`
